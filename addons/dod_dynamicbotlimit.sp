...
{
    g_CvarBotLimitMax = CreateConVar("dynamic_bot_limit_max", "20", "Maximum number of bot to allow regardless of spawn count");
    g_CvarBotLimitDelay = CreateConVar("dynamic_bot_limit_delay", "5", "Delay in seconds before overrideing default limit at round start");
